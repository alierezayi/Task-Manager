  ...
  return (
    <div>
      <Menu as="div" className="relative inline-block">
        <div>
          <Menu.Button className="avatar placeholder">
            <div className="w-8 bg-gradient-to-br from-[#a6c0fe] to-[#f68084] text-white rounded-full flex items-center justify-center" />
          </Menu.Button>
        </div>
        <Transition
          as={Fragment}
